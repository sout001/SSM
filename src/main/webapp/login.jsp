      ...
      <ul class="nav navbar-nav site-nav-sns"> 
       ...
       <li> <a href="#" class="icon-sns wechat"> 
         <div class="social-content"> 
          ...
          <p><img src="<%=basePath %>static/images/qr-code.jpg" /></p>
         </div> </a> </li> 
      </ul> 
      <!-- For non-login users --> 
    ...
    <div class="login-content"> 
     <div class="row"> 
      ...
      <div class="col-xs-4 login-content-form"> 
       ...
       <form name="loginForm" class="loginForm" action="<%=request.getContextPath()%>/login" role="form" method="post" ng-submit="submit()" novalidate="">
